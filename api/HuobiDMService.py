...
from api.HuobiDMUtil import http_get_request, api_key_post
...
class HuobiDM:
    ...
    def get_time(self):
        ...
        if isinstance(ci, dict) and (ci['status'] == 'ok'):
            return int(ci['ts']/1000)
        else:
            return 0
    ...
    # 合约下单
    def send_contract_order(self, symbol, contract_type, contract_code=None,
                            client_order_id=None, price=0, volume=0, direction=None, offset=None,
                            lever_rate=1, order_price_type=None):
        """
        :symbol: "BTC","ETH"..
